...
| Notebook | Description |
|----------|-------------|
| `3b_generative_models.ipynb` | Introduction to generative modeling — GANs, VAEs |
| `Sparse,_Contractive,_and_Variational_Auto_Encoders.ipynb` | Sparse AE, Contractive AE, and VAE implementations |

#### 📁 Generative AI Assignment (`Generative Ai assignment/`)

Course assignments exploring generative AI architectures:

| Notebook | Description |
|----------|-------------|
| `VAE_CIFAR10.ipynb` | Variational Autoencoder trained on CIFAR-10 dataset |
| `3b_generative_models.ipynb` | Generative models exploration (assignment submission) |
